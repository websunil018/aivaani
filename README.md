...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/aivaani)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/aivaani
```

A live public deployment of this template is available at [https://aivaani.templates.workers.dev](https://aivaani.templates.workers.dev)
